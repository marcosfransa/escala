...
$.getJSON("https://marcosfransa.github.io/escala/scripts/escala.json", function(obj) {
	...
	if (param1=="") {var pagina = obj.roots.bookmark_bar.children;}else{var pagina = obj.roots.bookmark_bar.children[param1].children;}*/
	events = obj.roots.bookmark_bar.children
});
